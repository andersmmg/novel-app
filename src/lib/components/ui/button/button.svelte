<script lang="ts" module>
	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				default:
					"bg-primary text-primary-foreground shadow-xs hover:bg-primary/90 border-primary hover:border-primary/90 border",
				destructive:
...
{#snippet Button({ props }: { props?: Record })}
	...
	{:else}
		<button bind:this={ref} {type} {disabled} {...mergedProps}>
			{@render children?.()}
		</button>
	{/if}
{/snippet}
